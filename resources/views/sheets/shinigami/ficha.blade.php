...
@section('sheetDelete')
<a class="btn btn-danger me-1" data-bs-toggle="modal" data-bs-target="#deleteSheetShinigamiModal">Excluir</a>
@endsection
@endif
                ...
                <form id="almaModalCreateForm" class="row row-cols-1 text-start">
                    ...
                    <div class="col mb-3">
                        <div class="row justify-content-between">
                            ...
                            <div class="col">
                                <input class="form-control bg-transparent text-center" type="text" style="color: white;" name="propriedade">
                            </div>
                        </div>
                    </div>
...
@if(Auth::User()->role_as == 'admin')
<!-- DELETE MODAL SHINIGAMI -->
<div class="modal fade" id="deleteSheetShinigamiModal" tabindex="-1" aria-labelledby="deleteSheetModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content bg-dark">
            <div class="modal-header">
